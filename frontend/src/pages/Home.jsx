        ...
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="flex flex-col md:flex-row justify-around items-center">
            <div className="relative mb-8 md:mb-0">
              <div className="w-16 h-16 rounded-full bg-teal-700 text-amber-100 ml-10 font-bold flex items-center justify-center text-2xl shadow-md">
                1
              </div>
              <h3 className="text-xl font-semibold text-teal-800 mt-4">Submit</h3>
              <p className="text-teal-700">Describe your issue.</p>
            </div>
            <div className="hidden md:block text-teal-700 text-3xl">&rarr;</div>
            <div className="relative mb-8 md:mb-0">
              <div className="w-16 h-16 rounded-full bg-teal-700 text-amber-100 ml-10 font-bold flex items-center justify-center text-2xl shadow-md">
                2
              </div>
            ...
            <div className="relative">
              <div className="w-16 h-16 rounded-full bg-teal-700 text-amber-100 ml-14 font-bold flex items-center justify-center text-2xl shadow-md">
                3
              </div>
